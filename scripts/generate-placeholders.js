...
const placeholders = [
  { name: 'test-hero.jpg', width: 1920, height: 1080, label: 'A', quality: 95 },
  { name: 'zenova-sky-premium-ocean-view-suite-jeju.jpg', width: 1600, height: 900, label: 'B', quality: 90 },
  { name: 'test-high-res.jpg', width: 2400, height: 1600, label: 'C', quality: 100 },
  { name: 'test-compressed.jpg', width: 800, height: 600, label: 'D', quality: 60 },
  { name: 'test-article-context.jpg', width: 1200, height: 800, label: 'E', quality: 85 },
  { name: 'img001.jpg', width: 1000, height: 667, label: 'F', quality: 75 },
  { name: 'zenova-sky-jeju-oceanview-suite.jpg', width: 1800, height: 1200, label: 'G', quality: 88 },
  { name: 'test-schema-rich.jpg', width: 1920, height: 1280, label: 'H', quality: 92 },
  { name: 'user-test-image.jpg', width: 1920, height: 1080, label: '★', quality: 90 },
];

async function generatePlaceholder(config) {
  const { name, width, height, label, quality } = config;
  ...
  console.log(`✓ Generated ${name} (${width}x${height}, Q${quality}, Label: ${label})`);
}
